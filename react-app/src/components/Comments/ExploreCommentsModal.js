...
import EditCommentForm from "./ExploreEditCommentsForm";
import AddCommentForm from "./ExploreAddCommentsForm";
...
return (
    <>
        ...
        <div className="modal-parent">   
            <button  id="close-modal-explore" onClick={() => setModalIsOpen(false)}>Close Window</button>
        </div>
        {sessionUser && <AddCommentForm photo_id={photo_id} />}
